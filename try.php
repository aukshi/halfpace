...
<div class="w3-accordion w3-light-grey">
  ...
  <div id="Demo1" class="w3-accordion-content w3-container">
                  <div class="content">
                      ...
                      ?>
                                <div class="squaredOne w3-dropdown-click">
                                    <input type="checkbox" onclick="myFunctionForCheck(this)" value="None" id="<?php echo $squared[$i];?>" name="check" />
                                    <label for="<?php echo $squared[$i];?>"><font size="3"> <?php echo $item;?> </font>
                                    <div id="drop" style="display:none" class="drop w3-card-4">
